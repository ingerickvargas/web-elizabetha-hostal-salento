...
@section('title', 'Contacto | Elizabetha Hostal en Salento')
@section('meta_description', 'Contáctanos para reservas en Elizabetha Hostal, Salento. Hospedaje ideal para parejas y familias cerca del Valle de Cocora.')
